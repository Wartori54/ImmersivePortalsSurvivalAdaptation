...
import net.wartori.imm_ptl_surv_adapt.mixin.OrePlacedFeaturesAccessor;
...
public class Register {
    ...
    public static StructurePieceType NON_EUCLIDEAN_HOUSE_PIECE = (StructurePieceType.ManagerAware) NonEuclideanHouseGenerator.NonEuclideanHousePiece::new;
    ...
    public static final ConfiguredStructureFeature<DefaultFeatureConfig, ? extends StructureFeature<DefaultFeatureConfig>> NON_EUCLIDEAN_HOUSE_CONFIGURED = NON_EUCLIDEAN_HOUSE_STRUCTURE.configure(DefaultFeatureConfig.INSTANCE);
    ...
    public static final ImmutableList<OreFeatureConfig.Target> PORTAL_ORE_TARGETS =
            ImmutableList.of(OreFeatureConfig.createTarget(OreConfiguredFeatures.STONE_ORE_REPLACEABLES, PORTAL_ORE.getDefaultState()),
                    OreFeatureConfig.createTarget(OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES, PORTAL_ORE_DEEPSLATE.getDefaultState()));
    ...
    public static final ConfiguredFeature<?, ?> PORTAL_ORE_OVERWORLD = Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, Utils.myId("portal_ore_overworld"),
            Feature.ORE.configure(PORTAL_ORE_CONFIG));

    public static final PlacedFeature PORTAL_ORE_NORMAL = Registry.register(BuiltinRegistries.PLACED_FEATURE, Utils.myId("portal_ore_normal"),
            PORTAL_ORE_OVERWORLD.withPlacement(OrePlacedFeaturesAccessor.CallModifiersWithCount(10, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(0), YOffset.fixed(64 + 32)))));
