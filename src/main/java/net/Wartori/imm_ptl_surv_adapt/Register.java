...
public class Register {
    ...
    protected static void registerItems() {
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_block"), new BlockItem(PORTAL_BLOCK, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_modificator"), PORTAL_MODIFICATOR_ITEM);
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_modificator_distance_modifier"), PORTAL_MODIFICATOR_DISTANCE_MODIFIER_ITEM);
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_modificator_rotation_modifier"), PORTAL_MODIFICATOR_ROTATION_MODIFIER_ITEM);
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_creator_one_way"), PORTAL_CREATOR_ONE_WAY);
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_ore"), new BlockItem(PORTAL_ORE, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_ingot"), PORTAL_INGOT);
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "used_portal_block"), new BlockItem(USED_PORTAL_BLOCK, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
        Registry.register(net.minecraft.util.registry.Registry.ITEM, new Identifier("imm_ptl_surv_adapt", "portal_modificator_delete"), PORTAL_MODIFICATOR_DELETE_ITEM);

    }

    protected static void registerBlocks() {
        Registry.register(Registry.BLOCK, new Identifier("imm_ptl_surv_adapt", "portal_block"), PORTAL_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier("imm_ptl_surv_adapt", "portal_ore"), PORTAL_ORE);
        Registry.register(Registry.BLOCK, new Identifier("imm_ptl_surv_adapt", "used_portal_block"), USED_PORTAL_BLOCK);
    }
    ...
    protected static void registerWorldGen() {
        RegistryKey<ConfiguredFeature<?, ?>> orePortalOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
                new Identifier("imm_ptl_surv_adapt", "ore_portal_overworld"));
    ...
    protected static void registerStructures() {
        ...
        FabricStructureBuilder.create(new Identifier("imm_ptl_surv_adapt:non_eucledian_house_structure"), NON_EUCLIDEAN_HOUSE_STRUCTURE)
        ...
        RegistryKey<ConfiguredStructureFeature<?, ?>> nonEuclideanHouseConfigured = RegistryKey.of(Registry.CONFIGURED_STRUCTURE_FEATURE_WORLDGEN,
                new Identifier("imm_ptl_surv_adapt:non_eucledian_house_structure"));
